...
F =
  \begin{bmatrix}
    \frac{\partial t}{\partial x} \big(x_n + 0.1y_n\big) & \frac{\partial t}{\partial y} \big(x_n + 0.1y_n\big) \\
    \frac{\partial t}{\partial x} \big(y_n - 0.1cos(x_n) + 0.5sin(t_n)\big) & \frac{\partial t}{\partial y} \big(y_n - 0.1cos(x_n) + 0.5sin(t_n) \big)
  \end{bmatrix}
\]
$$
